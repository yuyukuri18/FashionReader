...
class ViewModel: ObservableObject {
    ...
    func setImage(imagePath: String?) -> UIImage {
        ...
        let savedImagePath = UserDefaults.standard.string(forKey: "\(imagePath)")!.replacingOccurrences(of: "file://", with: "")
        ...
        do {
            ...
            return UIImage(data: savedImageData) ?? UIImage(named: "dummy")!
        } catch {
            print("\(savedImagePath)")
